package com.vinay.phonepequiz.adapters;
...
import com.vinay.phonepequiz.MainActivity;
                        ...
                        if (String.valueOf(mainActivity.answer).contains(suggestSource.get(i)))
                        {
                            ...
                            for (int i=0; i<mainActivity.answer.length;i++)
                            {
                                if (compare == mainActivity.answer[i])
                                    Utility.user_submit_answer[i] = compare;
                            }

                            GridViewAnswerAdapter answerAdapter = new GridViewAnswerAdapter(Utility.user_submit_answer,context);
